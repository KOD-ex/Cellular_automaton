...
Правила игрок может корректировать и назначать количество соседних клеток нужных для появления новой клетки и количество соседних клеток нужных для выживания клетки.
